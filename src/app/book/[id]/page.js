                  ...
                  <div className="inner__wrapper">
                    <div className="inner__book">
                      ...
                      <div className="inner-book__wrapper">
                        <div className="inner-book__description--wrapper">
                          ...
                          <div class="inner-book__description">
                            ...
                            <div class="inner-book__duration">
                              {book.duration}
                            </div>
                          </div>
                          <div class="inner-book__description">
                            ...
                            <div class="inner-book__type">{book.type}</div>
                          </div>
                          <div class="inner-book__description">
                            <div class="inner-book__icon">
                              <svg
                            ...
                            <div class="inner-book__key--ideas">
                      ...
                      <div class="inner-book__read--btn-wrapper">
                        <button class="inner-book__read--btn">
                      ...
                      <div class="inner-book__secondary--title">
                        What's it about?
                      </div>

                      {/* TAGS */}
                      <div class="inner-book__tags--wrapper">
                        <div class="inner-book__tag">
                          {book.tags.map((tag) => (
                      ...
                      <h2 class="inner-book__secondary--title">
                        About the Author
                      </h2>
